...
async function fetchWords(){
  const words = await fetch("https://random-word-api.herokuapp.com/word?number=150").then(response => response.json())
  return words
};

(async function initGame(){
  //loading state
  const loadingCircle = document.getElementById("loaderSel")
